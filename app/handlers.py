...
UNIVERSAL_SALES_TEXT = (
    "Здравствуйте! 🙌\n"
    "Вы ранее интересовались нашим туалетным столиком.\n\n"
    "Сейчас у нас идёт акция на 48 часов ⏳\n\n"
    "🔥 Обычный столик:\n"
    "было 130.000  → сейчас 100.000 тг\n\n"
    "💡 С подсветкой:\n"
    "было 180.000→ сейчас 130.000  тг\n\n"
    "❗️ Осталось ограниченное количество\n"
    "❗️ Акция строго на 48 часов (потом цена вернётся)\n\n"
    "📦 Доставка 2–3 дня по Казахстану\n\n"
    "👉 Напишите 100.000 или 130.000— закреплю за вами по акции"
)

...
UNIVERSAL_SALES_TEXT = (
    "Здравствуйте! 🙌\n\n"
    "Да, туалетный столик в наличии 👍\n"
    "Сейчас на него действует акция: вместо 150 000 тг — всего 100 000 тг 🔥\n\n"
    "По этой цене осталось совсем немного позиций, следующая поставка уже будет дороже.\n\n"
    "Если хотите, я сразу отправлю фото, видео и помогу рассчитать доставку 👌"
)

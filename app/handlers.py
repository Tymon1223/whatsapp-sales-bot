...
UNIVERSAL_SALES_TEXT = (
    "LUNA — больше, чем столик 🌙\n\n"
    "Это не просто мебель.\n"
    "Это место, где начинается ваш день.\n\n"
    "Мягкий bouclé, округлые формы и встроенное зеркало создают ощущение уюта и премиального стиля.\n\n"
    "✔ компактный дизайн\n"
    "✔ мягкое сиденье\n"
    "✔ удобное хранение\n"
    "✔ идеален для спальни, гардеробной и beauty-зоны\n\n"
    "Выберите свой цвет:\n"
    "Beige / Grey / Red / Pink / Brown / White\n\n"
    "LUNA — когда детали решают всё."
)
